...
// node_modules/@nostr/tools/fakejson.js
...
// node_modules/@nostr/tools/nip42.js
...
// node_modules/@nostr/tools/abstract-relay.js
...
// node_modules/@nostr/tools/helpers.js
var alwaysTrue = (t) => {
  t[verifiedSymbol] = true;
  return true;
};

// node_modules/@nostr/tools/abstract-pool.js
var AbstractSimplePool = class {
  ...
  subscribeMap(requests, params) {
    ...
    const allOpened = Promise.all(groupedRequests.map(async ({ url, filters }, i2) => {
      if (this.allowConnectingToRelay?.(url, [
        "read",
        filters
      ]) === false) {
...
// node_modules/@nostr/tools/nip44.js
...
function writeU16BE(num2) {
  if (!Number.isSafeInteger(num2) || num2 < minPlaintextSize || num2 > maxPlaintextSize) throw new Error("invalid plaintext size: must be between 1 and 65535 bytes");
...
function encrypt(plaintext, conversationKey, nonce = randomBytes(32)) {
  ...
  return base64.encode(concatBytes(new Uint8Array([
    2
